...
const I18N: Record<Lang, Translations> = {
  en: {
    ...
    mustMoveDestinationSet: "Destination: {room}",
    mustMoveDestinationMissing: "⚠ Destination not set",
    forcedStay: "Forced Stay",
    forceStayOption: "Force stay",
    movingIn: "Moving In",
    assign: "Assign →",
    destination: "Assign destination",
    done: "Complete",
    slots: "slots",
    reasonNoSupply: "No matching section is available in the current campus plan",
    ...
    roomFlagOfflineSlots: "{count} offline course slots in the recurring weekly schedule.",
    ...
    roomFlagQudratLevelClosed: "{count} students need {subject} {level}, but this level is not running in the current campus plan.",
    roomFlagQudratNoCompatible: "{count} students need Qudrat, but no compatible Qudrat section is available in the current campus plan.",
    unknown: "Unknown",
    moveAction: "Change",
  ...
  ar: {
    ...
    mustMoveDestinationSet: "الوجهة: {room}",
    mustMoveDestinationMissing: "⚠ الوجهة غير محددة",
    forcedStay: "يبقى (بدون بديل)",
    forceStayOption: "إبقاء الطالب",
    movingIn: "داخل",
    assign: "تعيين →",
    destination: "تعيين الوجهة",
    done: "مكتمل",
    slots: "حصص",
    reasonNoSupply: "لا توجد شعبة مناسبة متاحة في خطة المدرسة الحالية",
    ...
    roomFlagOfflineSlots: "{count} حصة مواد حضورية في الجدول الأسبوعي المتكرر.",
    roomFlagForcedStay: "{count} طالب مضطرون للبقاء في {course}{reason}.",
    roomFlagRosterOverflow: "العدد المتوقع في {course} هو {count} طالب.",
    roomFlagQudratLevelClosed: "{count} طلاب يحتاجون {subject} {level}، لكن هذا المستوى غير مُشغّل في خطة المدرسة الحالية.",
    roomFlagQudratNoCompatible: "{count} طلاب يحتاجون القدرات، لكن لا يوجد شعبة قدرات متوافقة في خطة المدرسة الحالية.",
    unknown: "غير معروف",
    moveAction: "تعديل",
